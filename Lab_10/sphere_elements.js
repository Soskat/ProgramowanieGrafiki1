...
function drawTriangle() {
    ...
    var vMatrix=concat(setPerspective(30, canvas.width/canvas.height, 1, 100),setLookAt(0, 0, 6, 0, 0, 0, 0, 1, 0));
    var viewMatrix = concat(vMatrix,modelMatrix);
    console.log(viewMatrix);
    gl.uniformMatrix4fv(u_MvpMatrix, false, viewMatrix);

    var normalMatrix = transpose(setInverseOf(modelMatrix));
